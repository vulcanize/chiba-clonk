...
- [ethermint/bond/v1/bond.proto](#ethermint/bond/v1/bond.proto)
    - [Bond](#ethermint.bond.v1.Bond)
    - [Params](#ethermint.bond.v1.Params)
  
- [ethermint/bond/v1/genesis.proto](#ethermint/bond/v1/genesis.proto)
    - [GenesisState](#ethermint.bond.v1.GenesisState)
  
- [ethermint/bond/v1/query.proto](#ethermint/bond/v1/query.proto)
    - [QueryGetBondByIdRequest](#ethermint.bond.v1.QueryGetBondByIdRequest)
    - [QueryGetBondByIdResponse](#ethermint.bond.v1.QueryGetBondByIdResponse)
    - [QueryGetBondModuleBalanceRequest](#ethermint.bond.v1.QueryGetBondModuleBalanceRequest)
    - [QueryGetBondModuleBalanceResponse](#ethermint.bond.v1.QueryGetBondModuleBalanceResponse)
    - [QueryGetBondsByOwnerRequest](#ethermint.bond.v1.QueryGetBondsByOwnerRequest)
    - [QueryGetBondsByOwnerResponse](#ethermint.bond.v1.QueryGetBondsByOwnerResponse)
    - [QueryGetBondsRequest](#ethermint.bond.v1.QueryGetBondsRequest)
    - [QueryGetBondsResponse](#ethermint.bond.v1.QueryGetBondsResponse)
    - [QueryParamRequest](#ethermint.bond.v1.QueryParamRequest)
    - [QueryParamsResponse](#ethermint.bond.v1.QueryParamsResponse)
  
    - [Query](#ethermint.bond.v1.Query)
  
- [ethermint/bond/v1/tx.proto](#ethermint/bond/v1/tx.proto)
    - [MsgCancelBond](#ethermint.bond.v1.MsgCancelBond)
    - [MsgCancelBondResponse](#ethermint.bond.v1.MsgCancelBondResponse)
    - [MsgCreateBond](#ethermint.bond.v1.MsgCreateBond)
    - [MsgCreateBondResponse](#ethermint.bond.v1.MsgCreateBondResponse)
    - [MsgRefillBond](#ethermint.bond.v1.MsgRefillBond)
    - [MsgRefillBondResponse](#ethermint.bond.v1.MsgRefillBondResponse)
    - [MsgWithdrawBond](#ethermint.bond.v1.MsgWithdrawBond)
    - [MsgWithdrawBondResponse](#ethermint.bond.v1.MsgWithdrawBondResponse)
  
    - [Msg](#ethermint.bond.v1.Msg)
...
<a name="ethermint/bond/v1/bond.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/bond/v1/bond.proto



<a name="ethermint.bond.v1.Bond"></a>
...
<a name="ethermint.bond.v1.Params"></a>
...
<a name="ethermint/bond/v1/genesis.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/bond/v1/genesis.proto



<a name="ethermint.bond.v1.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#ethermint.bond.v1.Params) |  | params defines all the parameters of the module. |
| `bonds` | [Bond](#ethermint.bond.v1.Bond) | repeated | bonds defines all the bonds |
...
<a name="ethermint/bond/v1/query.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/bond/v1/query.proto



<a name="ethermint.bond.v1.QueryGetBondByIdRequest"></a>
...
<a name="ethermint.bond.v1.QueryGetBondByIdResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `bond` | [Bond](#ethermint.bond.v1.Bond) |  |  |
...
<a name="ethermint.bond.v1.QueryGetBondModuleBalanceRequest"></a>
...
<a name="ethermint.bond.v1.QueryGetBondModuleBalanceResponse"></a>
...
<a name="ethermint.bond.v1.QueryGetBondsByOwnerRequest"></a>
...
<a name="ethermint.bond.v1.QueryGetBondsByOwnerResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `bonds` | [Bond](#ethermint.bond.v1.Bond) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  | pagination defines the pagination in the response. |
...
<a name="ethermint.bond.v1.QueryGetBondsRequest"></a>
...
<a name="ethermint.bond.v1.QueryGetBondsResponse"></a>
...
<a name="ethermint.bond.v1.QueryParamRequest"></a>
...
<a name="ethermint.bond.v1.QueryParamsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#ethermint.bond.v1.Params) |  |  |
...
<a name="ethermint.bond.v1.Query"></a>
...
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Params` | [QueryParamRequest](#ethermint.bond.v1.QueryParamRequest) | [QueryParamsResponse](#ethermint.bond.v1.QueryParamsResponse) | Bonds queries bonds list. | GET|/ethermint/bond/v1/params|
| `Bonds` | [QueryGetBondsRequest](#ethermint.bond.v1.QueryGetBondsRequest) | [QueryGetBondsResponse](#ethermint.bond.v1.QueryGetBondsResponse) | Bonds queries bonds list. | GET|/ethermint/bond/v1/bonds|
| `GetBondById` | [QueryGetBondByIdRequest](#ethermint.bond.v1.QueryGetBondByIdRequest) | [QueryGetBondByIdResponse](#ethermint.bond.v1.QueryGetBondByIdResponse) | GetBondById | GET|/ethermint/bond/v1/bonds/{id}|
| `GetBondsByOwner` | [QueryGetBondsByOwnerRequest](#ethermint.bond.v1.QueryGetBondsByOwnerRequest) | [QueryGetBondsByOwnerResponse](#ethermint.bond.v1.QueryGetBondsByOwnerResponse) | Get Bonds List by Owner | GET|/ethermint/bond/v1/bonds_by_owner|
| `GetBondsModuleBalance` | [QueryGetBondModuleBalanceRequest](#ethermint.bond.v1.QueryGetBondModuleBalanceRequest) | [QueryGetBondModuleBalanceResponse](#ethermint.bond.v1.QueryGetBondModuleBalanceResponse) | Get Bonds module balance | GET|/ethermint/bond/v1/balance|

 <!-- end services -->



<a name="ethermint/bond/v1/tx.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## ethermint/bond/v1/tx.proto



<a name="ethermint.bond.v1.MsgCancelBond"></a>
...
<a name="ethermint.bond.v1.MsgCancelBondResponse"></a>
...
<a name="ethermint.bond.v1.MsgCreateBond"></a>
...
<a name="ethermint.bond.v1.MsgCreateBondResponse"></a>
...
<a name="ethermint.bond.v1.MsgRefillBond"></a>
...
<a name="ethermint.bond.v1.MsgRefillBondResponse"></a>
...
<a name="ethermint.bond.v1.MsgWithdrawBondResponse"></a>
...
<a name="ethermint.bond.v1.Msg"></a>
